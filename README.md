...
- Consumes these two data sources
- Returns the combined list of countries and their populations.
- In the event of duplicate population data for a given country, the data from the sql database should be used.
